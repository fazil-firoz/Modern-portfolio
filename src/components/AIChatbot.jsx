...
export default function AIChatbot() {
  ...
  return (
    <>
      {/* ── FLOATING 3D PROJECTION AI BOT BUTTON (FIXED BOTTOM-LEFT - MATCHING WHATSAPP 3D STYLE) ── */}
      <button
        type="button"
        ...
        <div className="aibot-3d-inner">
          {isOpen ? (
            ...
            <svg className="aibot-3d-icon ai-robo-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
              ...
              {/* Antenna Pole */}
              <path d="M12 4.5V7.5" stroke="#38bdf8" strokeWidth="2" />
              {/* Outline Head Frame */}
              <rect x="4" y="7.5" width="16" height="12" rx="4" className="robo-head-frame" fill="none" stroke="#818cf8" strokeWidth="2" />
              {/* Outline Visor Window */}
              <rect x="6" y="9.5" width="12" height="4.5" rx="2" fill="none" stroke="#38bdf8" strokeWidth="1.4" />
              {/* Glowing Robot Eyes */}
